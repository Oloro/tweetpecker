    ...
    <div class="col-span-11">
      ...
      <div class="grid grid-cols-3 mt-4">
        ...
        <div class="ml-6">
          ...
          <span class="inline">{{ postData.content.retweetCount }}</span>
        </div>
        <div class="ml-6">
          <svg viewBox="0 0 24 24" class="inline w-5 mr-2">
            <g>
          ...
          <span class="inline">{{ postData.content.favoriteCount }}</span>
        </div>
      </div>
    </div>
  </div>
